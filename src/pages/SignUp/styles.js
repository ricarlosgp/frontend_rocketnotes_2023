...
import signup from '../../assets/imgdelogin.png'; //importando e nomeando a importação de imgsignin que vai receber de dentro da pasta assets a imagem chamada de imgdelogin.png 
...
/*
export const SignUpImg = styled.div` //exportando e criando um novo componente chamado de ImgSignUp que recebe do styled uma div para melhor estilizar a imagem na tela
    flex: 1; //a imagem ImgSignUp vai ocupar todo espaço disponível que sobrou após criar o Form(h1+h2+p+a)
    background: url(${imgsignup}) no-repeat center center; //através do background irei renderizar a imagem pegando ela pela url ( url(${imgsignin})) através da importação feita lá em cima(import imgsignin from '../../assets/imgdelogin.png';) buscando pelo nome da iportação que é imgsignin estou pedindo para que a imagem não se repita e vou centralizar ela (no-repeat center center) 
